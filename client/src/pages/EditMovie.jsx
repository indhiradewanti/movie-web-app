...
import { EDIT_MOVIE_MUTATION, FETCH_MOVIE, FETCH_ALL, FETCH_MOVIES } from "../graphql";
...
export default function EditPage() {
  ...
  const [editMovie] = useMutation(EDIT_MOVIE_MUTATION, {
    refetchQueries: [FETCH_ALL, FETCH_MOVIES],
  });
    ...
    <div className="flex justify-center">
      <div className="-mt-24 relative w-screen bg-center bg-no-repeat bg-cover bg-yellow-900 bg-opacity-95 top-0 left-0" style={{ backgroundImage: `url(${background})` }}>
        <div class="max-w-xl mx-auto text-center py-36">
          ...
          <h2 class="font-display font-bold text-3xl md:text-4xl text-white mt-3">Edit Movie</h2>

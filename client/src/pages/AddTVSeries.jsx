...
import { ADD_TVSERIES_MUTATION, FETCH_ALL } from "../graphql";
...
export default function AddPage() {
  ...
  const [addTvSeries] = useMutation(ADD_TVSERIES_MUTATION, {
  ...
  const background = `https://m.media-amazon.com/images/M/MV5BMjUzN2YwNWMtZDM2ZC00NTEwLTkwY2ItODMzNDEwOGExYjZjL2ltYWdlL2ltYWdlXkEyXkFqcGdeQXVyNTc3MjUzNTI@._V1_.jpg`;
    ...
    <div className="flex justify-center">
      <div className="-mt-24 relative w-screen bg-center bg-no-repeat bg-cover bg-yellow-900 bg-opacity-95 top-0 left-0" style={{ backgroundImage: `url(${background})` }}>
        <div class="max-w-xl mx-auto text-center py-36">
          ...
          <h2 class="font-display font-bold text-3xl md:text-4xl text-white mt-3">Add New TV Series</h2>

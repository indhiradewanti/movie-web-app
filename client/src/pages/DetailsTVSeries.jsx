...
import { FETCH_ALL, DELETE_TVSERIES_MUTATION, FETCH_ONE_TVSERIES } from "../graphql";
          ...
          <section className="text-gray-700 body-font overflow-hidden  justify-center items-center align-middle">
            <div className="container py-24 mx-auto">
              <div className=" flex flex-wrap justify-center items-center">
                <img alt="ecommerce" className="w-60 object-cover object-center rounded border border-gray-200" src={tvSeriesData.tvSeriesOne.poster_path} />
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  <h2 className="text-sm title-font text-white tracking-widest">MOVIE TITLE</h2>
                  <h1 className=" text-3xl title-font font-medium mb-1 text-white">{tvSeriesData.tvSeriesOne.title}</h1>
                  <div className="flex mb-4">
                    <span className="flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="white">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
                      <span className="ml-3 text-white">{tvSeriesData.tvSeriesOne.popularity}</span>
                    </span>
                    <span className="flex ml-3 pl-3 py-2 border-l-2 border-gray-200">
                      <div className="text-center">
                        {tvSeriesData.tvSeriesOne.tags.map((tag) => {
                          return <kbd className="kbd kbd-xs mx-2">{tag}</kbd>;
                        })}
                      </div>
                    </span>
                  </div>
                  <p className="leading-relaxed text-white">{tvSeriesData.tvSeriesOne.overview}</p>
                  ...
                  <div className=" text-center tracking-wide grid grid-cols-3 gap-6">
                    <button
                      ...
                      onClick={() => {
                        edit(tvSeriesData.tvSeriesOne._id);
                      }}
                    >
                    ...
                    <button
                      className="flex justify-center"
                      onClick={() => {
                        remove(tvSeriesData.tvSeriesOne._id);
                      }}
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="white">
                    ...
                    <button
                      className="flex justify-center"
                      onClick={() => {
                        favTvSeries(tvSeriesData.tvSeriesOne);
                      }}
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="white">
